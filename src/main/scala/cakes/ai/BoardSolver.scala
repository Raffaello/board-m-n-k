...
object BoardSolver extends App {
  ...
  sealed class MiniMaxRaw(m: Short, n: Short, k: Short) extends SolverBoardRaw(m, n, k) {
    def result(): Int = old.minimax(this, isMaximizingPlayer = true)
  }

  sealed class MiniMaxTraitRaw(m: Short, n: Short, k: Short) extends SolverBoardAiTrait(m, n, k) with cakes.ai.MiniMaxRaw {
  ...
  sealed class NegaMaxRaw(m: Short, n: Short, k: Short) extends SolverBoardRaw(m, n, k) {
    def result(): Int = old.negamax(this, 1)
  }
  ...
  sealed class AlphaBetaRaw(m: Short, n: Short, k: Short) extends SolverBoardRaw(m, n, k) {
    def result(): Double = alphaBeta(this)
  }

  sealed class AlphaBetaTTOld(m: Short, n: Short, k: Short) extends SolverBoardOldRaw(m, n, k) with cakes.ai.old.TranspositionTable {
    def result(): cakes.ai.old.Transposition = old.alphaBetaWithMem(this, this)
  }

  sealed class AlphaBetaTT(m: Short, n: Short, k: Short) extends SolverBoardRaw(m, n, k) with TranspositionTable2dArrayString {
    def result(): Transposition = alphaBetaWithMem(this, this)
  }
  ...
  sealed class AlphaBetaTraitTTOld(m: Short, n: Short, k: Short) extends SolverBoardAiTrait(m, n, k) with AlphaBeta with cakes.ai.old.TranspositionTable {
    def result(): Int = this.solve
  }
